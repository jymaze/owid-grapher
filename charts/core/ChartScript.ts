...
import { AxisScaleOptionsInterface } from "charts/axis/AxisScale"
...
export class ChartScript {
    ...
    @observable.ref xAxis: Partial<AxisScaleOptionsInterface> = {}
    @observable.ref yAxis: Partial<AxisScaleOptionsInterface> = {}
